...
import {
    ...
    Platform,
    Alert, // Replaced by Alert.alert
    Dimensions
} from 'react-native';
// import { Alert.alert } from '../../utils/uiUtils.js';
...
const SignupScreen = ({ navigation }) => {
    ...
    const handleSendOtpClick = async () => {
        ...
        try {
            ...
            Alert.alert('Error', error.message || 'An unexpected error occurred while sending OTP.');
        } finally {
            setLoading(false);
        }
    };
    ...
    const handleFinalSignupClick = () => {
        ...
        // Just navigate to OTP verification - no more sending OTP here
