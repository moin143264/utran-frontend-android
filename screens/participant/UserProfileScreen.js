...
// import { Alert.alert } from '../../utils/uiUtils';
        ...
        try {
            ...
            if (!result.canceled) {
                ...
                try {
                    ...
                    formData.append('file', { uri: fileDetails.uri, type: fileDetails.type, name: fileDetails.name });
                    ...
                    if (uploadResult.secure_url) {
                        ...
                        updateUserProfile({ ...user, profileImage: uploadResult.secure_url });
